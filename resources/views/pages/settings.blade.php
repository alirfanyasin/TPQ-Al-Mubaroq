              ...
              <div class="tab-pane fade" id="jilid" role="tabpanel" aria-labelledby="jilid-tab">
                <section class="section">
                  <div class="row" id="basic-table">
                    <div class="card">
                      <div class="text-end">
                        <button type="button" class="btn icon icon-left btn-primary d-inline-block"
                          data-bs-toggle="modal" data-bs-target="#tambahJilidModal"><i data-feather="plus"></i>
                          Tambah
                        </button>
                      </div>
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama-jilid">
                          </div>
                        </div>
