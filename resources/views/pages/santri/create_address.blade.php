...
@section('content')
  <div class="page-content">
    <form action="{{ route('santri.store_address') }}" method="POST">
      @csrf
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="alamat-lengkap" name="alamat_lengkap_domisili"
                    ...
                    value="{{ old('alamat_lengkap_domisili', session('form_address_santri.alamat_lengkap_domisili')) }}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="desa" name="desa_domisili" placeholder=""
                    value="{{ old('desa_domisili', session('form_address_santri.desa_domisili')) }}">
                  @error('desa_domisili')
                    <small class="text-danger">{{ $message }}</small>
                  @enderror
                </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="rt" name="rt_domisili"
                    placeholder=""value="{{ old('rt_domisili', session('form_address_santri.rt_domisili')) }}">
                  @error('rt_domisili')
                    <small class="text-danger">{{ $message }}</small>
                  @enderror
                </div>
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="kecamatan" name="kecamatan_domisili"
                    placeholder=""value="{{ old('kecamatan_domisili', session('form_address_santri.kecamatan_domisili')) }}">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="rw" name="rw_domisili"
                    placeholder=""value="{{ old('rw_domisili', session('form_address_santri.rw_domisili')) }}">
                  @error('rw_domisili')
                    <small class="text-danger">{{ $message }}</small>
                  @enderror
                </div>
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="kabupaten" name="kota_domisili" placeholder=""
                    value="{{ old('kota_domisili', session('form_address_santri.kota_domisili')) }}">
                  @error('kota_domisili')
                    <small class="text-danger">{{ $message }}</small>
                  @enderror
                </div>
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="alamat-lengkap" placeholder="Jl. nama jalan, nomor rumah"
                    ...
                    value="{{ old('alamat_lengkap_kk', session('form_address_santri.alamat_lengkap_kk')) }}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="desa" placeholder="" name="desa_kk"
                    value="{{ old('desa_kk', session('form_address_santri.desa_kk')) }}">
                  @error('desa_kk')
                    <small class="text-danger">{{ $message }}</small>
                  @enderror
                </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="rt" placeholder="" name="rt_kk"
                    value="{{ old('rt_kk', session('form_address_santri.rt_kk')) }}">
                  @error('rt_kk')
                    <small class="text-danger">{{ $message }}</small>
                  @enderror
                </div>
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="kecamatan" placeholder="" name="kecamatan_kk"
                    value="{{ old('kecamatan_kk', session('form_address_santri.kecamatan_kk')) }}">
                  @error('kecamatan_kk')
                    <small class="text-danger">{{ $message }}</small>
                  @enderror
                </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="rw" placeholder="" name="rw_kk"
                    value="{{ old('rw_kk', session('form_address_santri.rw_kk')) }}">
                  @error('rw_kk')
                    <small class="text-danger">{{ $message }}</small>
                  @enderror
                </div>
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="kabupaten" placeholder="" name="kota_kk"
                    value="{{ old('kota_kk', session('form_address_santri.kota_kk')) }}">
                  @error('kota_kk')
                    <small class="text-danger">{{ $message }}</small>
                  @enderror
                </div>
              ...
              <div class="mt-3 justify-content-end d-flex">
                <a href="{{ route('santri.create_biodata') }}" class="btn icon icon-right btn-danger me-2">
