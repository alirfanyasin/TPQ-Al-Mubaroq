  ...
  <div class="sidebar-wrapper active">
      ...
      <div class="d-flex justify-content-between align-items-center">
        <div class="logo">
          ...
          <a href="index.html" class="d-flex justify-content-center align-items-center">
            <img src="/template/assets/images/logo/logo.png" alt="Logo" class="w-50 h-50">
            {{-- <div class="" style="display: flex; justify-content: center; width: 70px; height: 70px">
              <img src="/template/assets/images/logo/logo.png" alt="Logo" srcset="" class="w-100 h-100">
            </div> --}}
          </a>
        </div>
    ...
    <div class="sidebar-menu">
      <ul class="menu">
        ...
        <li
          class="sidebar-item {{ Request::is('santri/*') ? 'active' : '' }} {{ Request::is('santri') ? 'active' : '' }}">
        ...
        <li
          class="sidebar-item  {{ Request::is('asatidz/*') ? 'active' : '' }}  {{ Request::is('asatidz') ? 'active' : '' }}">
          <a href="{{ route('asatidz') }}" class='sidebar-link'>
